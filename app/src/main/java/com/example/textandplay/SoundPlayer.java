...
public class SoundPlayer {
  ...
  // soundpool is deprecated in api level 21 .(Lollipop)
        ...
        hitOrangeSound = soundPool.load(context,R.raw.ballbounce,1);
        hitPinkSound = soundPool.load(context,R.raw.ballbounce,1);
        hitBlackSound = soundPool.load(context,R.raw.ballbounce,1);
    }
